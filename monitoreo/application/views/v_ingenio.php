          ...
          <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Listado de Peronas Registradas en el Proyecto Ingenio
                            </h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <th scope="col" style="font-family: 'Dancing Script', cursive;">Brigadas</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                                <?php
                                ...
                                ?>
                                  <tr>
                                        ...
                                        <td><?php echo strtolower($listar->brigadas);?></td>
                                <?php
                                }
                                ?>
                                    </tbody>
