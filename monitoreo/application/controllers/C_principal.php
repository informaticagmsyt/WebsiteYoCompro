...
/*****************************************************************************************************************************/		
		...
		$paqcojedes = $this->m_listado->listado_parroquia_cojedes();
		$paqjuan = $this->m_listado->listado_parroquia_juan();
		$paqtinaquillo = $this->m_listado->listado_parroquia_tinaquillo();
		$paqbaul = $this->m_listado->listado_parroquia_baul();
		$paqsucre = $this->m_listado->listado_parroquia_sucre();
		$paqpao = $this->m_listado->listado_parroquia_pao();
		$paqlibertad = $this->m_listado->listado_parroquia_libertad();
		$paqamparo = $this->m_listado->listado_parroquia_amparo();
		$paqcarlos = $this->m_listado->listado_parroquia_carlos();
		$paqangel = $this->m_listado->listado_parroquia_angel();
		$paqmanuel = $this->m_listado->listado_parroquia_manuel();
		$paqgeneral = $this->m_listado->listado_parroquia_general();
		$paqmacapo = $this->m_listado->listado_parroquia_macapo();
		$paqaguadita = $this->m_listado->listado_parroquia_aguadita();
		$paqromulo = $this->m_listado->listado_parroquia_romulo();
/********************************************************************************************************************************/
